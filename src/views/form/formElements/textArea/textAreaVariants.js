...
const TextareaVariant = () => {
  ...
  return (
    <form noValidate autoComplete='off'>
      <Box className='demo-space-x' sx={{ mb: 4, display:"flex", gap:"20px", marginTop:"20px" }} >
        <TextField
          multiline
          maxRows={4}
          value={value}
      ...
      <Box className='demo-space-x' sx={{ mb: 4, display:"flex", gap:"20px"}}>
        <TextField
          multiline
          maxRows={4}
          value={value}
      ...
      <div className='demo-space-x' style={{ mb: 4, display:"flex", gap: "30px"}}>
        <TextField
          multiline
          maxRows={4}
          value={value}
